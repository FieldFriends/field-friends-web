...
### License
The source code in this repository is licensed under the [MIT License](LICENSE.md). However, the Field Friends name, logos, branding, and written website copy are **All Rights Reserved**. If you reuse this code, you must replace our branding and text with your own.
