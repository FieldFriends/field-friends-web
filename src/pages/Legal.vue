  ...
  <div class="legal-page bg-background text-primary d-flex flex-column">
    <v-container class="flex-grow-1 pt-12 pb-16 legal-page__content">
      ...
      <section class="mb-12" aria-labelledby="tos-heading">
        <h2 id="tos-heading" class="text-h4 font-weight-bold mb-6 text-primary">1. Terms of Service</h2>
        ...
        <p class="text-body-1 text-secondary mb-4 page-text">
          To use Field Friends, you must be 18 years of age or older and possess a valid <strong>@illinois.edu</strong> email address. By completing the sign-up process, you represent that you meet both conditions.
        </p>
      ...
      <section class="mb-12" aria-labelledby="privacy-heading">
        <h2 id="privacy-heading" class="text-h4 font-weight-bold mb-6 text-primary">2. Privacy Policy</h2>
        
        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Data Collection</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          When you sign up, we collect personal information necessary to match you and contact you. This includes your university email address, age bracket, gender identity, university affiliation, and open-ended text responses regarding your interests and activities.
        </p>

        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Data Usage & Email Communications</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          We use the collected information exclusively to facilitate the matching process. <strong class="text-primary">We will use your email address solely for sending matching results and critical administrative notices (such as secure login codes).</strong> We do not sell, rent, or trade your data to third parties. We do not use your email for marketing. 
        </p>

        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Data Security</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          We take the security of your data seriously. Before your survey responses and identifying information ever reach our cloud database, they are encrypted using AES-256 cloud encryption. The data is processed offline locally for the matching algorithm. 
        </p>

        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Data Retention & Opt-Out</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          Submitting the sign-up form implies consent to participate in the current monthly matching round. Because our data storage is ephemeral, all user records from a matching round are securely and permanently wiped after the matches for that round are sent out. If you wish to request total manual deletion of your data before the automatic wipe, please contact us at <strong>fieldfriends.team@gmail.com</strong>.
        </p>
      </section>
      ...
      <section class="mb-8" aria-labelledby="liability-heading">
        <h2 id="liability-heading" class="text-h4 font-weight-bold mb-6 text-primary">3. Liability Disclaimer</h2>
        
        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Not Affiliated</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          Field Friends is an independent project run by private individuals. It is not affiliated with, endorsed by, or sponsored by the University of Illinois Urbana-Champaign.
        </p>

        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">Passive Conduit & Assumption of Risk</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          Field Friends functions strictly as a data processor and a passive conduit for introductions. <strong class="text-primary">We do not perform background checks, vet users, or guarantee the safety of any individual.</strong> Users assume all risks associated with meeting their matches. We strongly advise using common sense: meet in public places, trust your instincts, and prioritize your safety.
        </p>

        <h3 class="text-h6 font-weight-bold mb-2 text-primary font-playfair">No Warranty</h3>
        <p class="text-body-1 text-secondary mb-4 page-text">
          The service is provided "as is" and "as available" without any warranties of any kind, either express or implied, including but not limited to the likelihood of forming lasting friendships or the suitability of the matches provided.
        </p>
